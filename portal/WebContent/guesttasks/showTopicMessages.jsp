...
Authenticate authData=AuthUtil.getAuthData(pageContext);
	...
	if (authData!=null){
		...
		if(authid.equals(mgr_id)){
			request.setAttribute("tasktitle","Community Manage > "+clubmanagelink+" > "+forumlink+" > View Topic");
			request.setAttribute("mtype","My Console");
			request.setAttribute("stype","Community");
		}
		else{
			request.setAttribute("tasktitle",clubnamelink+" > "+forumlink+" >  View Topic");
		}
	}
	else
		request.setAttribute("tasktitle",clubnamelink+" > "+forumlink+" >  View Topic");
...
<%
	...
	taskpage="/discussionforums/logic/showTopicMessages.jsp";
