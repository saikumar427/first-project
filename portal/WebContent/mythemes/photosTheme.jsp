...
<div class='memberbeelet-header'>My Photos Page Themes</div>
...
<td align="right" class="<%=base%>"><a href="/portal/mytasks/mytemplates.jsp?type=photo&customthemeid=<%=GenUtil.getHMvalue(hm,"themeid","")%>&title=My Photos Page Themes > <%=java.net.URLEncoder.encode(Themename)%>">Theme Templates</a>
<td class="<%=base%>" align='right'><a href="/portal/mytasks/myuserthemes.jsp?themeid=<%=GenUtil.getHMvalue(hm,"themeid","")%>&foract=edit&module=<%=module%>&title=My Photos Page Themes > <%=java.net.URLEncoder.encode(Themename)%>" >Edit</a></td>
...
<input type="hidden" name="title"  value="My Photos Page Themes"/>
</form>
</table>
