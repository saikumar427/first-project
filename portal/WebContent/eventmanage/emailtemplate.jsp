...
function getTemplates(evtid,type){
	...
	//alert(groupid);
		advAJAX.get( {			
		url : '/portal/eventmanage/getTemplate.jsp?groupid='+evtid+'&emailtype='+type,
...
EmailTemplate emailtemplate=null;
	String isformatexists=DbUtil.getVal("select 'yes' from email_templates where purpose='EVENT_REGISTARTION_CONFIRMATION' and groupid=?", new String []{groupid});
	if("yes".equals(isformatexists)){

	emailtemplate=new EmailTemplate("13579","EVENT_REGISTARTION_CONFIRMATION",groupid);
	}else{
...
tempmsg="";
%>
<form action="/portal/eventmanage/updateemailtemp.jsp" method="post" id="template"  ">
