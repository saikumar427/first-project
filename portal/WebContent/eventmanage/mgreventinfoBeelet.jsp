...
<tr ><td width="35%" class="oddbase">Manager</td>
...
<table width="100%"  cellspacing='0' cellpadding='0' class="portaltable">
<tr ><td class="evenbase" width="35%">Event Page Visits</td>
<td class="evenbase" align="left"><%=eventpageviews%></td>
</tr>
</table>
