...
<%
	...
	String purpose="RSVP_CONFIRMATION";
	StatusObj statobjn=null;	
	DbUtil.executeUpdateQuery(DELETE_TEMPLATE,new String[]{groupid});
	if("html".equals(format)){
	statobjn= DbUtil.executeUpdateQuery(INSERT_TEMPLATE,new	String[]{groupid,"RSVP - $eventName",emailtemplate,null,"$mgrEmail", "$mgrEmail",purpose,"13579"});
	}
	else{
	statobjn= DbUtil.executeUpdateQuery(INSERT_TEMPLATE,new	String[]{groupid,"RSVP -$eventName",null,emailtemplate,"$mgrEmail","$mgrEmail",purpose,"13579"});
	 }
