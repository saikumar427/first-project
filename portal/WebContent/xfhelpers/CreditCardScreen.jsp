...
var frm=document.getElementById("ebee-pay-form");
...
"TR","TM","TC","TV","UG","UA","AE","GB","UY","VU","VA","VE","VN","WF","YE","ZM"};
		...
		String getCardScreen(CreditCardModel ccm,String purpose){
			...
			String helplink="(<a href=\"javascript:popupwindow('"+linkpath+"/cvvcodehelp.html','Tags','600','400')\">Where is my CVV Code?</a>)";							
				...
				sb.append("<tr><td  height='30' class='inputlabel'>CVV Code *<br/>"+helplink+"</td><td height='30' class='inputvalue'  valign='top'>");
			...
			if(ccm.getProfiledata()!=null){
				...
				sb.append("<tr><td colspan='2' class='subheader'>Credit Card Billing Address</td></tr><tr><td width='240' height='30' class='inputlabel'>First Name *</td><td   width='240' height='30' class='inputvalue'>");
				...
				sb.append("</td></tr><tr><td height='30' class='inputlabel' id='statelabel'>State/Province *</td><td height='30' class='inputvalue'  ><div id='state' style='display:block'>");
...
<%
	...
	out.println(getCardScreen(  (CreditCardModel)request.getAttribute("ccm"),purpose )  ) ;
