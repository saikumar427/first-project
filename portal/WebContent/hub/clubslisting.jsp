...
List categoryName=DbUtil.getValues("select code from categories where purpose=? order by displayname",new String[]{club_title});
List categoryCode=DbUtil.getValues("select displayname from categories where purpose=? order by displayname",new String[]{club_title});
        ...
        <tr>
		  ...
		  <tr ><td colspan='2' >
		    <table border='0' cellpadding='0' cellspacing='0' width='100%' >
			  ...
			  Keyword</td>
		      <td width='1%'></td>
		      <td ><input type="text" name="keyword" value="<%=reqkeyword%>" size="20"/></td>
		      <td width='1%'></td>
		      <td valign='center'>Type</td>
		      <td width='1%'></td>
		      <td ><%=WriteSelectHTML.getSelectHtml((String[])categoryName.toArray(new String[0]),(String[])categoryCode.toArray(new String[0]),"type",reqtype,null,null)%></td>
		      <td width='1%'></td>
                    </tr>
