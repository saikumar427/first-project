...
<%!
String CLASS_NAME="club/clubview/themecontroller.jsp";
...
public void processContent(HttpServletRequest request,Authenticate authData ){
	...
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"club/clubview/themecontroller.jsp, in processContent method","themetype  is  :"+themetype,"",null);

	String modulename=request.getParameter("purpose");
	
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"club/clubview/themecontroller.jsp, in processContent method","modulename  is  :"+modulename,"",null);

	String formname=request.getParameter("formname");
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"/club/clubview/themecontroller.jsp, in processContent method","formname  is  :"+formname,"",null);

	String userid=authData.getUserID();
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"/club/clubview/themecontroller.jsp, in processContent method","userid  is  :"+userid,"",null);
	String unitid=authData.getUnitID();
	
	String act=request.getParameter("act");
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"/club/clubview/themecontroller.jsp, in processContent method","act  is  :"+act,"",null);

	String themecode=request.getParameter("userthemecode");
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"/club/clubview/themecontroller.jsp, in processContent method","themecode  is  :"+themecode,"",null);

	String themeid=request.getParameter("themeid");
	EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"/club/clubview/themecontroller.jsp, in processContent method","themeid  is  :"+themeid,"",null);
...
<%
	if("edit".equals(formname)){
		...
		response.sendRedirect(PageUtil.appendLinkWithGroup("ThemeDone.jsp?from=add&type=hubstheme", (HashMap)request.getAttribute("REQMAP")    )     );
	}
