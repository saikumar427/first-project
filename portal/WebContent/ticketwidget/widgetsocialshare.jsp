...
sbf.append("<div class=\"well row \" style=\"margin:0px;\"><div class=\"col-md-12 text-center row \"><b>Tell your friends!</b></div><br>");
...
sbf.append("</div><br>");
sbf.append("<div class=\"text-center col-md-12 col-sm-12 \" style=\"display:none;\" id=\"show_ref_link\"><input type=\"text\" ng-copy=\"copy_url();\" class=\"text-center\" id=\"evereflink\" readonly=\"readonly\" value=\""+eventurl+"\" size=\"50\"  onclick=\"this.setSelectionRange(0, this.value.length)\" style=\"background-color: transparent;border: 0px;\"></div><br></div>");
