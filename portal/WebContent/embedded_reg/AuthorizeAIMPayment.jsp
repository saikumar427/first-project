...
public class AuthorizeAIMPaymentProcess
{
	HashMap<String,String> processPayment(CreditCardModel ccm,HttpServletRequest request){
		...
		String state=request.getParameter("state")==null || "".equalsIgnoreCase(request.getParameter("state")) ? "default" : request.getParameter("state");
		System.out.println(tid+" :: autherize state :::: "+request.getParameter("state"));
	...
	HashMap<String,String> getAPIDetails(String eid){
		String query="select attrib_2,attrib_3 from payment_types where refid=? and paytype='eventbee' and attrib_5='authorize.net'";
