...
function submitamount(){
	...
	if(data.indexOf("Success")>=-1){
		makeRequest("/portal/webintegration/SeturCommsion.jsp?groupid="+groupid+"&partnerid="+partnerid,"update");

		}	 if(data.indexOf("Invalid")>=-1){
			makeRequest("/portal/webintegration/SeturCommsion.jsp?error=yes&groupid="+groupid+"&partnerid="+partnerid,"update");
