...
var INDIA_REGION_CODES=new Array("ahmedabad","bangalore","chennai","delhi","hyderabad","kolkata","mumbai","other");
	...
	function CallCountries(){
		...
		var defval=document.getElementById("hcountry");
	...
	var SelObj=document.getElementById("country");
			...
			var innTxt=document.createTextNode(" -- Select State -- ");
			...
			StateObj.appendChild(oOption);

					

			var defval=document.getElementById("hstate");
	...
	function CallStates1(country,state,hstate){
...
function CallRegions(country,region,hregion){
	...
	for(var i=RegionObj.length-1;i>=0;i--){
	...
	var defval=document.getElementById(hregion);



	var REGIONS=null;

	var REGION_CODES=null;
	...
	if(country=='USA'){
		...
		REGION_CODES=US_REGION_CODES;

	}else if(country=='UK'){

		REGIONS=UK;

		REGION_CODES=UK_CODES;

	}else if(country=='India'){

		REGIONS=INDIA_REGIONS;

		REGION_CODES=INDIA_REGION_CODES;
			...
			REGION_CODES=CANADA_REGION_CODES;

	}

	

	innTxt=document.createTextNode(" -- Select Region -- ");
	...
	if(REGIONS!=null){
		...
		for(var i=0;i<REGIONS.length;i++){
			...
			var txt = document.createTextNode(REGIONS[i]);

			var sttxt=REGION_CODES[i];
			...
			oOption.setAttribute('value',REGION_CODES[i]);

			oOption.setAttribute('id',REGION_CODES[i]);
		...
		oOption.setAttribute('value','other');
