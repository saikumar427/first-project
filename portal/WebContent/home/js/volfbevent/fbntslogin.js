...
function populatefblogindata(data){
	...
	htmldata+=msg+"<center><span id='loginas'>Logged in as</span><br><a href='"+data.link+"' style='text-decoration:none;' target='_blank'><img src='https://graph.facebook.com/"+data.id+"/picture' border='0'><br><span>"+data.name+"</span></a>&nbsp;&nbsp;<span style='float:left;color:blue;' id='notyou'>(Not you?)</span></center><br>";
	
	htmldata+="<center><img src='/main/images/fb-connect.png' class='fbcommentbutton' border='0'><br><span ><a id='skipstep'>Skip this step</a></span></center>";
...
function fillfblogindefaultcontent(){
		//fbpopupwait();
var msg="<p>Keep track of your purchases with your Facebook login.</p>";
var htmldata="<img src='/home/images/images/close.png' id='fbloginpopup' class='imgclose'>"+msg+"<center><img src='/main/images/login-button.png' class='fbloginbutton' border='0'><br><a id='skipstep'>Skip this step</a></center>";
