...
try{
	...
	String U_ERT_query="update event_reg_transactions set fname=?, lname=?, email=?, phone=? where tid=? ";
	...
	ArrayList<String[]> U_ERT_records = new ArrayList<String[]>();
	...
	if(!obj.isNull("buyer")){
		...
		U_ERT_records.add(new String[]{fname, lname, email, phone, tid});
	...
	String[] dbqueries = new String[]{U_BBP_query, U_TBP_query, D_CQR_query, D_CQRM_query, I_CQRM_query, I_CQR_query,U_ERT_query};
	ArrayList<String[]>[] paramset = new ArrayList[]{U_BBP_records, U_TBP_records,D_CQR_records, D_CQRM_records, I_CQRM_records, I_CQR_records,U_ERT_records};
