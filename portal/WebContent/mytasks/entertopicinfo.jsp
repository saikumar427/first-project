...
String clubname="";
String mgr_id=" ";String authid=null;
if(!"-1".equals(clubid))
hm=gethubdet(clubid);
...
Authenticate authData=AuthUtil.getAuthData(pageContext);
	...
	{
request.setAttribute("tasktitle","Community Manage > "+clubmanagelink+" > Add Topic");
request.setAttribute("mtype","My Console");
request.setAttribute("stype","Community");
}
else{
request.setAttribute("tasktitle",clubnamelink+" > "+forumlink+" > Add Topic");
...
<%
	...
	taskpage="/discussionforums/logic/entertopicinfo.jsp";
