...
if(topicid==null)
topicid=GenUtil.getHMvalue(fourmHash,"topicid");
...
if(custompurpose!=null){			 
	...
	if (authData!=null){
		...
		if(authid.equals(mgr_id)){
			request.setAttribute("tasktitle","Community Manage > "+clubmanagelink+" > "+forumlink+" > "+topiclink+" >  Post Reply");
...
<%
	...
	taskpage="/discussionforums/logic/entermsginfo.jsp";
