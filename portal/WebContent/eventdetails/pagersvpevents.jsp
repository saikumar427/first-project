...
<%
	...
	if(!("000000".equals(id1)|| "".equals(id1)|| "0".equals(id1))){
	  ...
	  request.setAttribute("tasksubtitle","RSVP Events");
	}else{
...
%>
	...
	<% if(!("000000".equals(id1)|| "".equals(id1)|| "0".equals(id1))){ 
      		Vector mylistedevts1=AccountDB.getMemRSVPEvents(id1);
		List mylistedevts=null;
		pageNatingException pageException=null;
		pageNating pageNav=new pageNating();
		try{
			pageNav.setLink(PageUtil.appendLinkWithGroup("/portal/eventdetails/pagersvpevents.jsp?userid="+id1,(HashMap)request.getAttribute("REQMAP")));
