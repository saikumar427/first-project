<div align="center" class="footertop">
  ...
  <td align="left" valign="top" >
	 ...
	 <td valign="top">
	  ...
	  <span class="footertabheader"><h2>Eventbee</h2></span>
	   ...
	   <div align="left" style="padding:0px;vertical-align: middle;"><a href="http://twitter.com/eventbee" style="background-image: url(<%=resourceaddress%>/main/images/home/icon_twitter.png);background-repeat: no-repeat;padding-left: 29px;display:block;height:28px;">Twitter </a> </div>
		
        <div align="left" style="padding:0px;vertical-align: middle;"><a href="http://facebook.com/eventbeeinc" style="background-image: url(<%=resourceaddress%>/main/images/home/icon_facebook.png);background-repeat: no-repeat;padding-left: 29px;display:block;height:28px;">Facebook </a></div>
       <div align="left" style="padding:0px;vertical-align: middle;"><a href="http://blog.eventbee.com/" style="background-image: url(<%=resourceaddress%>/main/images/home/icon_blog.png);background-repeat: no-repeat;padding-left: 29px;display:block;height:28px;">Blog</a></div>
	 <div align="left" style="padding:0px;vertical-align: middle;"><a href=" http://www.youtube.com/user/eventbee/videos" target="_blank" style="background-image: url(<%=resourceaddress%>/main/images/home/iconYouTube.png);background-repeat: no-repeat;padding-left: 29px;display:block;height:28px;">Videos</a></div>
    ...
    <table  align="left" valign="top" cellpadding="0" cellspacing="0" width="100%"><tr>
	 ...
	 <span class="footertabheader"><h2>More Solutions</h2></span>
	  <span class="footertab"><a href="http://www.volumebee.com">Volumebee - Get one to many with Volumebee!</a></span> <br/>
	   <span class="footertab">Eventbee Attendee Check-In App<br/><span><a href="http://itunes.apple.com/us/app/eventbee-real-time-attendee/id403069848?mt=8"><img src="<%=resourceaddress%>/main/images/home/iphone.png" border="0"></a></span><!-- <span style="padding-left:10px;"> <a href="https://market.android.com/details?id=com.eventbee.mobile"><img src="/main/images/home/android_as.png" border="0"></a></span> --></span>
  ...
  <td  align="left" valign="top" >
    <table  align="left" valign="top" cellpadding="0" cellspacing="0" width="100%"><tr>
	 ...
	 <span class="footertab"><a href="/main/good">Giveback Program</a></span><br/>
...
<div align="center">
	...
	<img src="<%=resourceaddress%>/main/images/footer/percentagefee.jpg" border="0" alt="$1 Flat Fee Per Ticket Sale"/>
	<img src="<%=resourceaddress%>/main/images/footer/aws.jpg" border="0" alt="Powered By Amazon Webservices"/>
	
</div> 

<div align="center" >
    <span class="footertab">Copyright 2003-2014. Eventbee Inc. All Rights Reserved.</span><br/>
	...
	<span class="footertab">Trusted by 30,000+ Event Managers all over the world for their Online Registration, Event Ticketing, Email Marketing and Event Promotion needs!</span>
</div>
