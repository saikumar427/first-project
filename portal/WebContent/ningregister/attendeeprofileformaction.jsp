...
String profileCount=request.getParameter("currentcount");
...
String firstname=request.getParameter("P"+(i+1)+"fname");
String lastname=request.getParameter("P"+(i+1)+"lname");
String email=request.getParameter("P"+(i+1)+"email");
String phone=request.getParameter("P"+(i+1)+"phone");
...
String responses[]=request.getParameterValues("P"+(i+1)+"Q"+(j+1));
qresponse=GenUtil.stringArrayToStr(responses,",");
}
else{
qresponse=request.getParameter("P"+(i+1)+"Q"+(j+1));
}
