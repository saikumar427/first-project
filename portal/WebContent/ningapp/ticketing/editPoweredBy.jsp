...
request.setAttribute("tasktitle", Myevents+" > Event Manage > "+link+" > Online Regiatration");
//request.setAttribute("tasktitle","Event Manage > "+link+" > Online Regiatration");
...
%>
<jsp:include page='/editevent/editPoweredBy.jsp'>
