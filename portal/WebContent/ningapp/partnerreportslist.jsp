...
document.report.action = '/portal/ningapp/partner_reports.jsp?rtype=fo';
document.report.target = '_blank';
document.report.submit;
return true;
}
function generateExcel(ext,agentid,groupid){ 
document.report.action = '/portal/ningapp/partner_reports.jsp?rtype=excel';
document.report.submit;
return true;
}
</script>

<form name="report" method="post" action="/ningapp/excelreports.jsp">
...
<tr><td><div  STYLE=" height: 300px; width: 550px; font-size: 12px; overflow: auto;"/>
