...
<%!
  ...
  Vector getFriendslist(String userid)
	...
	%>
	<html>
	<form action="/portal/ningapp/getemails.jsp" method="post" id="mails" name="myform" onSubmit="getmailonsubmit('<%=request.getParameter("groupid")%>'); return false;">
...
<%} %>
	...
	<br><input type='checkbox' name='chxbox' id='chxbox' value="<%=email%>"><%=fname%>
</td>
