...
report.fillColumn(content,rowdisplay(i) ,"<a href='"+appname+"/mytasks/partnertransaction.jsp?key="+GenUtil.AllXMLEncode((String)hmt.get("transactionid"))+"&amp;GROUPID="+groupid+"&amp;groupid="+groupid+"&amp;cardtype="+type+"&amp;agentid="+agentid+"'>"+GenUtil.AllXMLEncode((String)hmt.get("transactionid"))+"</a>");
