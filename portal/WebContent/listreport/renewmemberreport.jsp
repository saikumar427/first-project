...
document.report.action ='/portal/listreport/renewmembership_report.jsp?rtype=fo';
document.report.submit;
return true;
}
function generateExcel(ext){ 

document.report.action = '/portal/listreport/renewmembership_report.jsp?rtype=excel';
document.report.submit;
return true;
