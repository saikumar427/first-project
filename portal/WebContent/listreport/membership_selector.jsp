...
<%@ page import="com.eventbee.clubmember.ClubDB" %>
<%@ page import="java.text.SimpleDateFormat"%>
<%@ page import="com.eventbee.clubs.ClubMemberShip" %>

<%
EventbeeLogger.log(EventbeeLogger.LOGGER_MAIN,EventbeeLogger.DEBUG,"membership_selector.jsp","Authdata is not null. Authid: "+((AuthUtil.getAuthData(pageContext)!=null)?AuthUtil.getAuthData(pageContext).getUserID():"Auth data is null"),"sessionid: "+session.getId()+", time: "+(new java.util.Date()).toString(),null);
String unitid=null;
    String groupid=null;
...
<form method="post" action="/mytasks/membership_report.jsp">
...
<tr>
<td align="right" width="40%"><input type="radio" name="selindex" value="2"/></td>
<td>Start Date
