...
<%
Hashtable propmap=System.getProperties();
...
if(submit != null){
	...
	if("SetVal".equals(submit)){
		...
		if( !("".equals(tempkey) ) ){
			System.setProperty(tempkey,request.getParameter("val").trim());
	...
	if("GetVal".equals(submit)){
		...
		key1=tempkey;
		if( !("".equals(tempkey) ) ){
		val1=System.getProperty(tempkey,null);
		if(val1 ==null){
...
<body>
<form	action="systemproperties" method="post">
