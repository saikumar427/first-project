...
public class BCustomAttribute{
	...
	private ArrayList<BAttribOption> attriboptions=new ArrayList<BAttribOption>();
	

	public BCustomAttribute(){
	...
	public void setOptions(ArrayList<BAttribOption> options){
		this.attriboptions=options;
	}
	public ArrayList<BAttribOption> getOptions(){
