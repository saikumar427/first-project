...
HashMap<String,HashMap<String, String>> getrecurringEventdetails(String eventid,String evtdate,String ticketurlcode)
{
	...
	try{
		...
		System.out.println("(Box Office)exception in getrecurringEventdetails"+e.getMessage());
	}
	return detailsMap;
...
public  HashMap<String,String> getConfigValuesFromDb(String eventid){
