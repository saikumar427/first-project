...
public class BRegConfirmationDBHelper{
...
public void fillConfirmation(String tid,String eid,JspWriter out){
	try{
		BRegistrationDBHelper regdb=new BRegistrationDBHelper();
		BRegistrationTiketingManager regmgr=new BRegistrationTiketingManager();
		...
		BTicketsDB tktdb=new BTicketsDB();
		...
		String template= regtktmgr.getVelocityTemplate(eid,"confirmationpage");
